...
public class GameListener implements Observer {
	...
	/**
	 * der Aktioner der die Information des Aktuellen raumes enthält
	 */
	private BackroundActioner backRndAct;
	/**
	 * der Actioner der die Aktuellen Kommandos enthält
	 */
	private KommandActioner kmdAct;
	/**
	 * der Aktioner der das Spielerinventar enthält
	 */
	private InventarActioner inventAct;
	/**
	 * der Actioner der das Roominventar enthält
	 */
	...
	/**
	 * enthält die Spielergröße
	 */
	private SizeActioner sizeActioner;
